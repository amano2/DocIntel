  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border/50 bg-background px-2.5 py-1.5 text-xs shadow-xl transition-all dark:bg-slate-900 dark:border-slate-800",
          className
        )}
      >
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "flex items-center justify-center gap-4 pt-2 text-xs",
